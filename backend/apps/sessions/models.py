...
class SessionCoach(TenantAwareModel):
    ...
    coach = models.ForeignKey(
        "accounts.User", on_delete=models.CASCADE, related_name="coaching_sessions"
    )
...
class Enrollment(TenantAwareModel):
    session = models.ForeignKey(
        SessionOccurrence, on_delete=models.CASCADE, related_name="enrollments"
    )
    player = models.ForeignKey(
        "players.Player", on_delete=models.CASCADE, related_name="enrollments"
    )
...
class ScheduleConflict(TenantAwareModel):
    occurrence = models.ForeignKey(
        SessionOccurrence, on_delete=models.CASCADE, related_name="conflicts"
    )
